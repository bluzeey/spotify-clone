...
import {RewindIcon,PauseIcon,FastForwardIcon,SwitchHorizontalIcon,PlayIcon,ReplyIcon,VolumeUpIcon,VolumeOffIcon} from '@heroicons/react/solid'
        ...
        <div className="h-24 bg-gradient-to-b from-black
         to-gray-900 text-white grid grid-cols-3
          text-xs md:text-base px-2 md:px-8">
            ...
            <div className="flex items-center space-x-3 md:space-x-4 justify-end pd-5">
